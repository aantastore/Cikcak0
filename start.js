...
require('./index.js')
nocache('./index.js', module => console.log(`${module} Auto Update © AnggaXc`))

async function starts(beta = new WAConnection()){
  beta.logger.level = 'warn';
  beta.version = [2, 2146, 9]
  beta.browserDescription = [ 'Beta Base By AnggaZyy', 'Safari', '3.0' ];
  ...
  beta.on('connecting', () => {
  	console.log("[ BOT ]", color("Menghubungkan....","cyan"));
  });
